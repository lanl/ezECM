...
All methods use typicality indices as part of the decision framework.  For all methods, the significance level `alpha` is set to `0.05`.
...
\mathrm{a}_k & \mathrm{a}_{\cancel{k}}
\end{array}\\
C = &
\begin{array}{c}
\mathrm{True}\\
